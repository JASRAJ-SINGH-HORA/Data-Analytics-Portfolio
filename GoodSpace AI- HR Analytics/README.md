...
!\[Process Overview Dashboard](path/to/your/image\_page1.png)

&nbsp;KPIs: Tracks Speed (10.7h), SLA Compliance (84%), and Drop-off Rates.
...
!\[Strategy Dashboard](path/to/your/image\_page2.png)
